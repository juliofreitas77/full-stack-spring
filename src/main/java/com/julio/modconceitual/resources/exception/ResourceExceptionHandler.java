package com.julio.modconceitual.resources.exception;
...
import com.julio.modconceitual.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(), "Erro da validação",
				System.currentTimeMillis());
	...
	public ResponseEntity<StandardError> amazonSercice(AmazonServiceException e, HttpServletRequest request) {
